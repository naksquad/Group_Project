...
Public Class updatemailingadress
    ...
    Private Sub enterPatient()
        ...
        query &= "UPDATE user_table SET user_address = @Address WHERE user_id = @id"
        ...
        Using conn As New SqlConnection("Server=DESKTOP-JHVG5RN\SQLEXPRESS01;Database=lecole;Trusted_Connection=True;")
            Using comm As New SqlCommand()
                With comm
                    ...
                    .Parameters.AddWithValue("@Address", textbxy.Text)
    ...
    Private Sub updatemailingadress_Load(sender As Object, e As EventArgs) Handles MyBase.Load
